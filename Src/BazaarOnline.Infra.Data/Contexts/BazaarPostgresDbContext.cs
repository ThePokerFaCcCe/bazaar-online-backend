...
{
    public class BazaarPostgresDbContext : DbContext
    {
        public BazaarPostgresDbContext(DbContextOptions<BazaarPostgresDbContext> options) : base(options)
        {
            AppContext.SetSwitch("Npgsql.EnableLegacyTimestampBehavior", true);
        }

        public BazaarPostgresDbContext()
        {
            AppContext.SetSwitch("Npgsql.EnableLegacyTimestampBehavior", true);
        }
